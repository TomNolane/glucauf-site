...
// if((isset($_POST['name'])&&$_POST['name']!="")&&(isset($_POST['phone'])&&$_POST['phone']!="")&&(isset($_POST['email'])&&$_POST['email']!="")&&(isset($_POST['inn'])&&$_POST['inn']!="")){ //Проверка отправилось ли наше поля name и не пустые ли они
...
//                   <br>
//                   <p>Пожелания, комментарии: '.htmlentities(trim($_POST['message'])).'</p>  
//                   <br>   
